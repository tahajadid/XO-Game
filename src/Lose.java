...
public class Lose extends JDialog {
	...
	public Lose(String J) {
		...
		lblNewLabel.setIcon(new ImageIcon(Win.class.getResource("/image_win/Back_Ground_JD33.png")));
	...
	public static void InitMusic() {
		try {
			musicB = new FileInputStream(new File("music/lose.wav"));
